...
@implementation HSWalletTodayOneCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        UILabel *label2 = [[UILabel alloc]initWithFrame:CGRectMake(kRealValue(138),kRealValue(105), kRealValue(150), kRealValue(30))];
        ...
        UILabel *label3 = [[UILabel alloc]initWithFrame:CGRectMake(kRealValue(251),kRealValue(105), kRealValue(150), kRealValue(30))];
        label3.font = [UIFont fontWithName:kPingFangMedium size:kFontValue(13)];
        ...
        lineImageView1.frame = CGRectMake(kRealValue(115), kRealValue(111), 1,44);
        [backView addSubview:lineImageView1];
        
        UIImageView *lineImageView2 = [[UIImageView alloc] initWithImage:kGetImage(@"today_lineView")];
        lineImageView2.frame = CGRectMake(kRealValue(229), kRealValue(111), 1,44);
        [backView addSubview:lineImageView2];
        ...
        self.midLabel = [[UILabel alloc]initWithFrame:CGRectMake(kRealValue(138),kRealValue(125), kRealValue(150), kRealValue(30))];
        ...
        self.rightLabel = [[UILabel alloc]initWithFrame:CGRectMake(kRealValue(251),kRealValue(125), kRealValue(150), kRealValue(30))];
        self.rightLabel.font = [UIFont fontWithName:kPingFangMedium size:kFontValue(13)];
        self.rightLabel.textColor =[UIColor colorWithHexString:@"#666666"];
        self.rightLabel.text = @"333333";
