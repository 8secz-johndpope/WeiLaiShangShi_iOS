...
-(void)createview
{
    self.bgview = [[UIView alloc]initWithFrame:CGRectMake(kRealValue(12), 0,kScreenWidth- kRealValue(24), kRealValue(74))];
    self.bgview.backgroundColor = KColorFromRGB(0xffffff);
    [self addSubview:self.bgview];
    UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect: self.bgview.bounds byRoundingCorners:UIRectCornerBottomRight | UIRectCornerBottomLeft cornerRadii:CGSizeMake(6,6)];
    //创建 layer
